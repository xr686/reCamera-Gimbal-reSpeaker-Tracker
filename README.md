...
To communicate with the reSpeaker via USB, install the following dependencies on your PC:
```bash
...
5. Click **"Import Node File"**, select the JSON file you downloaded from this GitHub repository, and click **Import**.
...
2. **Test Mechanism**: First, ensure Node-RED is running on the reCamera. Then, run the Python script on your PC. Speak into the microphone—you should see the Python terminal continuously printing `SPEECH_DETECTED: 1`, while the reCamera rapidly turns towards the angle of your voice.
